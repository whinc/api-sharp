...
function () {
  ...
  _proto.processApi = function processApi(api) {
    !api ? process.env.NODE_ENV !== "production" ? invariant(false, "api 为空") : invariant(false) : void 0;
    ...
    if (!api.url || !String(api.url)) {
       process.env.NODE_ENV !== "production" ? invariant(false, "url \u4E3A\u7A7A") : invariant(false) ;
    } else {
    ...
    if (isUndefined(api.method)) {
      ...
      _api.method = api.method.toUpperCase();
       ...
       process.env.NODE_ENV !== "production" ? invariant(false, "method \u671F\u671B\u503C\u4E3A get|post \u5176\u4E00\uFF0C\u5B9E\u9645\u503C\u4E3A\"" + api.method + "\"") : invariant(false) ;
    }
    ...
    if (_api.method.toUpperCase() !== "GET" && _api.enableCache) {
      ...
      process.env.NODE_ENV !== "production" ? warning(false, "\u53EA\u6709 GET \u8BF7\u6C42\u652F\u6301\u5F00\u542F\u7F13\u5B58\uFF0C\u5F53\u524D\u8BF7\u6C42\u65B9\u6CD5\u4E3A\"" + _api.method + "\"\uFF0C\u7F13\u5B58\u5F00\u542F\u4E0D\u4F1A\u751F\u6548") : void 0;
    } // 缓存时间
    ...
    if (isUndefined(api.cacheTime)) {
      ...
      _api.cacheTime = this.cacheTime;
      process.env.NODE_ENV !== "production" ? warning(false, "cacheTime \u671F\u671B number/function \u7C7B\u578B\uFF0C\u5B9E\u9645\u7C7B\u578B\u4E3A" + typeof api.cacheTime + "\uFF0C\u81EA\u52A8\u4F7F\u7528\u9ED8\u8BA4\u503C") : void 0;
    }
    ...
    if (isUndefined(api.retryTimes)) {
      ...
      _api.retryTimes = this.retryTimes;
      process.env.NODE_ENV !== "production" ? warning(false, "retryTimes \u671F\u671B number/function \u7C7B\u578B\uFF0C\u5B9E\u9645\u7C7B\u578B\u4E3A" + typeof api.retryTimes + "\uFF0C\u81EA\u52A8\u4F7F\u7528\u9ED8\u8BA4\u503C") : void 0;
    }
    ...
    if (isUndefined(api.paramsTransformer)) {
      ...
      _paramsTransformer = this.paramsTransformer;
      process.env.NODE_ENV !== "production" ? warning(false, "paramsTransformer \u671F\u671B\u4E00\u4E2A\u51FD\u6570\uFF0C\u5B9E\u9645\u63A5\u6536\u5230" + typeof api.paramsTransformer) : void 0;
    }
...
export { WebAxiosClient, WebXhrClient };
//# sourceMappingURL=api-sharp.esm.js.map
